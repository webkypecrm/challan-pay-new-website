          ...
          <SheetDescription className="bg-white rounded-lg p-3 text-black">
            <div className="space-y-4 text-sm leading-relaxed text-gray-800">
              <p className="text-xs">
                ...
                <span className="font-semibold">Lawyered</span> full
                authorization to contest all traffic challans issued against me
                across any and all geographical locations in India. This
                authorization includes the power to represent me before traffic
                authorities, courts, tribunals, and other relevant judicial or
              ...
              <p className="text-xs">
                ...
                undertake all necessary legal and procedural actions on my
                behalf, including the preparation and submission of documents,
                filing applications, attending hearings, making oral and written
              ...
              <p className="text-xs">
                ...
                outcome of the contestation is subject to the discretion of the
                authorities and courts, and that no guarantee or assurance can
                be provided regarding the dismissal, reduction, or waiver of any
                fines or penalties.
              </p>
              ...
              <p className="text-xs font-medium">
                I declare that I have read, understood, and voluntarily accept
                all terms and conditions of this authorization.
              </p>
            </div>
